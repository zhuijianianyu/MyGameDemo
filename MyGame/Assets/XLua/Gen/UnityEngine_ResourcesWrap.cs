...
namespace XLua.CSObjectWrap
{
    ...
    public class UnityEngineResourcesWrap 
    {
        public static void __Register(RealStatePtr L)
        {
            ...
            Utils.RegisterFunc(L, Utils.CLS_IDX, "EntityIdsToObjectList", _m_EntityIdsToObjectList_xlua_st_);
        ...
        [MonoPInvokeCallbackAttribute(typeof(LuaCSFunction))]
        static int _m_EntityIdsToObjectList_xlua_st_(RealStatePtr L)
        {
		    try {
                ...
                
                {
                    ...
                    UnityEngine.Resources.EntityIdsToObjectList( _entityIds, _objects );
